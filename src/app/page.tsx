...
export default function Home() {
  ...
  const featureCards = [
    {
      ...
      description:
        "Interactive walkthroughs with photorealistic quality powered by Unreal Engine 5.",
    ...
    },
    {
      ...
      title: "Global Access",
      description:
        "Share your visualizations with clients anywhere in the world.",
    ...
    },
    {
      ...
      description:
        "Experience immersive visualizations on any device, including mobile phones and tablets.",
  ...
  useEffect(() => {
    const detectDevice = () => {
      ...
      const isTablet =
        /iPad|Android(?=.*\bTablet\b)/i.test(userAgent) ||
    ...
    if (index !== null) {
      ...
      if (index < sections.length) {
        ...
        if (section) {
          ...
          const lenis = (
            window as { lenis?: { scrollTo: (element: Element) => void } }
          ).lenis;
          if (lenis) {
    ...
    <LenisProvider>
      <div className="relative">
        ...
        <div className="fixed inset-0 overflow-hidden">
          ...
          <div
            className="absolute top-1/4 left-1/4 w-[40vw] h-[40vw] rounded-full bg-emerald-900/20 blur-3xl animate-pulse"
            style={{ animationDuration: "15s" }}
          />
          <div
            className="absolute bottom-1/4 right-1/4 w-[30vw] h-[30vw] rounded-full bg-emerald-600/20 blur-3xl animate-pulse"
            style={{ animationDuration: "12s", animationDelay: "2s" }}
          />
          <div
            className="absolute top-3/4 right-1/3 w-[20vw] h-[20vw] rounded-full bg-emerald-700/20 blur-3xl animate-pulse"
          ...
          {/* Floating 3D Objects */}
          <div
            className="absolute top-[15%] left-[10%] w-24 h-24 opacity-20 animate-float"
          ...
          <div
            className="absolute top-[45%] right-[15%] w-16 h-16 opacity-20 animate-rotate-3d"
          ...
          <div
            className="absolute bottom-[20%] left-[20%] w-20 h-20 opacity-20 animate-float-slow"
          ...
          >
            ...
            >
              <path
                d="M12 7L17 10.5V17.5L12 21L7 17.5V10.5L12 7Z"
                stroke="currentColor"
                strokeWidth="0.5"
                fill="currentColor"
                fillOpacity="0.2"
              />
              <path
                d="M12 7V2M7 10.5L2 7M17 10.5L22 7"
                stroke="currentColor"
                strokeWidth="0.5"
              />
            </svg>
          ...
          <div
            className="absolute top-[65%] right-[10%] w-24 h-24 opacity-20 animate-float-slower"
        ...
        <Cursor hoveredIcon={hoveredIcon} cursorVisible={cursorVisible} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                  ...
                  <p
                    ...
                    onMouseLeave={handleMouseLeave}
                  >
                    Flik is a premier architectural visualization studio
                    creating immersive experiences with cutting-edge technology.
                  </p>
                  ...
                  {icons.map((iconData, index) => (
                    <button
                      ...
                      className={`nav-button ${
                        clickedIcon === index ||
                        (clickedIcon === null && hoveredIcon === index)
                          ? "active"
                          : ""
                      }`}
