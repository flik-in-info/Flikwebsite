...
const colSpanClasses = ['md:col-span-5 lg:col-span-5', 'md:col-span-7 lg:col-span-7', 'md:col-span-7 lg:col-span-7', 'md:col-span-5 lg:col-span-5'];
      ...
      <section className="max-w-7xl mx-auto px-5 py-12">
        <div className="mb-6">
          ...
          <p className="text-lg max-w-2xl text-left mt-2 font-manrope">
            Flik delivers high-quality architectural renderings, including 360-degree views, walk-throughs, and VR experiences.
          </p>
        </div>
